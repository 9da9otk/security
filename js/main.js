...
<html lang="ar" dir="rtl">
  <head>
    ...
    <!-- ستايل أساسي: ملء الشاشة + زجاجيات -->
    <style>
      ...
      .toolbar .badge { font-size:12px; padding:2px 8px; border-radius:8px; border:1px solid rgba(255,255,255,.18) }
      ...
      /* مودال المستلمين العامّين (اختياري) */
      ...
      /* اجعل الفقاعة الأصلية لخرائط Google شفافة (سيُستكمل بالـ JS) */
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_GOOGLE_MAPS_API_KEY&libraries=geometry&callback=initMap" defer></script>
  </body>
</html>
